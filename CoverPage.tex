...
\renewcommand\maketitle{
	\begin{alwayssingle}
		\begin{center}
			...
			Рекомендовано Методичною радою КПІ ім. Ігоря Сікорського як навчальний посібник для здобувачів ступеня бакалавра за спеціальністю 105 Прикладна фізика та наноматеріали
			\end{center}
...
\newcommand\makeinfopage{
	\begin{alwayssingle}
        ...
        \end{minipage}\hfill
        \begin{minipage}[t]{0.78\linewidth}
                \href{https://intellect.kpi.ua/profile/ssa34}{С.~А.~Смирнов}, к.ф.-м.н., с.н.с., заступник директора Фізико-технічного інституту КПІ ім. Ігоря Сікорського з методичної роботи
        \end{minipage}
