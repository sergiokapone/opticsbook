...
\newcommand\makeinfopage{
	\begin{alwayssingle}
        ...
        \begin{minipage}[t]{0.78\linewidth}
                \href{https://www.nas.gov.ua/UA/PersonalSite/Statuses/Pages/default.aspx?PersonID=0000013213}{В.~Б.~Тараненко}, д.ф.-м.н., с.н.с., директор Філії прикладної оптики Інституту фізики НАН України\\[1ex]
                \href{http://intellect.ooep.kpi.ua/profile/kvg11}{В.~Г.~Колобородов}, д.т.н., професор кафедри комп’ютерно-інтегрованих оптичних та навігаційних систем Приладобудівного факультету КПІ ім. Ігоря Сікорського
        \end{minipage}
        ...
        \end{minipage}\hfill
        \begin{minipage}[t]{0.78\linewidth}
                \href{http://ipt.kpi.ua/litvinova}{С.~А.~Смирнов}, к.ф.-м.н., доцент, заступник директора Фізико-технічного інституту КПІ ім. Ігоря Сікорського з методичної роботи
        \end{minipage}
...
%		\end{flushleft}
        ...
        Наведені теоретичні відомості та приклади, які ілюструють практичні підходи до розв'язування задач з курсу оптики, а також \TotalValue{totalproblems} питань і задач для самостійного розв’язку.  До більшості задач подано відповіді. Задачі різноманітні як за змістом, так і за складністю.
